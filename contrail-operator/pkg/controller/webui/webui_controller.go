...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &contrailoperatorsv1alpha1.WebUI{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &contrailoperatorsv1alpha1.WebUI{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileWebUI) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &contrailoperatorsv1alpha1.WebUI{}
...
func newDSForCR(cr *contrailoperatorsv1alpha1.WebUI) *appsv1.DaemonSet{
...
func initContainersForDS(cr *contrailoperatorsv1alpha1.WebUI) []corev1.Container{
...
func containersForDS(cr *contrailoperatorsv1alpha1.WebUI) []corev1.Container{
	return []corev1.Container{
	{
	...
	},
	{
		...
		Image:   		"opencontrailnightly/contrail-controller-webui-job",
		Command: 		[]string{"./entrypoint.sh"},
		ImagePullPolicy: "IfNotPresent",
		SecurityContext:	&corev1.SecurityContext{
						Privileged: func(b bool) *bool { return &b }(true),
